...
const { Program, CoursePackage, Course } = require('../models/educationSchema') // Adjust path
const MONGO_URI = 'mongodb://mindful_admin:newmindful1337@localhost:27017/mindful' // Adjust URI
        ...
        omfattning: row['Omfattning']
          ? String(row['Omfattning']) // Ensure it's a string
              ...
              .map((value) => {
                ...
                if (isNaN(num)) {
                  console.warn(`Invalid number in 'Omfattning': ${value}`)
